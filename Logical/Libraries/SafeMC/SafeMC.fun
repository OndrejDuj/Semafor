...
FUNCTION_BLOCK SafeMC_ReadSafeInData3       (*Read SafeIN data3*)
    VAR_INPUT
        Axis        :UDINT;                 (*axis reference*)
        Enable      :BOOL;                  (*when set the data is read*)
    END_VAR
    VAR_OUTPUT
        ...
        Error       :BOOL;                  (*error occurred in FB*)
        ErrorID     :UINT;                  (*error number*)
        SafeInData  :ACP10SAFEINDAT3_typ;   (*SafeIN data3*)
    END_VAR
END_FUNCTION_BLOCK
...
FUNCTION_BLOCK SafeMC_ReadSafeOutData3      (*Read SafeOUT data3*)
    VAR_INPUT
        Axis        :UDINT;                 (*axis reference*)
        Enable      :BOOL;                  (*when set the data is read*)
    END_VAR
    VAR_OUTPUT
        ...
        Error       :BOOL;                  (*error occurred in FB*)
        ErrorID     :UINT;                  (*error number*)
        SafeOutData :ACP10SAFEOUTDAT3_typ;  (*SafeOUT data3*)
    END_VAR
END_FUNCTION_BLOCK
